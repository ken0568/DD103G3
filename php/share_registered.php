<?php
    ...
    $sql="INSERT INTO `member` (`memId`,`memPsw`,`memName`,`memNick`,`sex`,`email`,`memTel`,`petType`,`petPic`,`status`,`petName`,`coin`,`Feelfull`,`feedNum`,`lastFeed`,`petColor`) VALUES (:memId,:memPsw,:memName,:memNick,:sex,:email,:memTel,null,null,1,null,0,null,0,null,null)";
